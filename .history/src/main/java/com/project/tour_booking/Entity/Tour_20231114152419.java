...
public class Tour {
  ...
  public String toString() {
    return "Tour [id=" + id + ", name=" + name + ", description=" + description + ", service=" + service + ", time="
        + time + ", quantity=" + quantity + ", schedule=" + schedule + ", priceForAdult=" + priceForAdult
        + ", priceForChildren=" + priceForChildren + ", departurePoint=" + departurePoint + ", dateOfPosting="
        + dateOfPosting + ", editDate=" + editDate + ", status=" + status + ", isHot=" + isHot + ", departureDays="
        + departureDays + ", departureDay=" + departureDay + ", images=" + images + ", tourImages=" + tourImages
        + ", totId=" + totId + ", typeOfTour=" + typeOfTour + ", tourReviews=" + tourReviews + ", bookings=" + bookings
        + "]";
  }
