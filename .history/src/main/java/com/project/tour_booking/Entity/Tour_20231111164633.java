...
public class Tour {
  ...
  @NonNull
  @NotBlank(message = "Số lượng người của tour không được để trống!")
  ...
  private List<String> departureDays = new ArrayList<>();

  // @NonNull
  // @JsonFormat(pattern = "dd-MM-yyyy") // format chuỗi ngày tháng năm
  // @ValidDepartureDay(message = "Thời gian khởi hàng phải sau thời điểm hiện
  // tại!")
