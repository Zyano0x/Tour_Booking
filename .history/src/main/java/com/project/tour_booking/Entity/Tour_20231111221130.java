...
import com.project.tour_booking.CustomValidator.ValidListDepartureDay;
...
public class Tour {
  ...
  @ValidListDepartureDay(message = "Ngày khởi hành phải lớn hơn thời điểm tạo tour!")
