...
public class BookingServiceImpl implements BookingService {
  ...
  public void updateStatusBooking(Long bookingId) {
    ...
    // System.out.println("status " + updateStatusBooking.getStatus());
    Tour updateTour = tourRepository.findById(updateStatusBooking.getTour().getId()).get();
    // System.out.println("/update" + updateTour.toString());
    ...
    if (updateStatusBooking.getStatus() == true) {
      ...
      // false);
      Integer temp = updateTour.getQuantity() + total;
      System.out.println(temp);
      updateTour.setQuantity(temp);
    } else {
