...
public class BookingServiceImpl implements BookingService {
  ...
  public void updateStatusBooking(Long bookingId) {
    ...
    // Tour updateTour =
    // tourRepository.findById(updateStatusBooking.getTour().getId()).get();
    ...
    if (updateStatusBooking.getStatus() == true) {
      ...
      tourService.updateQuantityTour(updateStatusBooking.getTour().getId(), total, false);
      // updateTour.setQuantity(updateTour.getQuantity() + total);
    } else {
      updateStatusBooking.setStatus(true);
      tourService.updateQuantityTour(updateStatusBooking.getTour().getId(), total, true);
      // updateTour.setQuantity(updateTour.getQuantity() - total);
    }
