...
public class BookingServiceImpl implements BookingService {
  ...
  public void saveBooking(Booking booking, Long userId, Long tourId) {
    ...
    booking.setTotalPrice((new BigDecimal(booking.getQuantityOfAdult()) * tour.getPriceForAdult())
        + (new BigDecimal(booking.getQuantityOfChild()) * tour.getPriceForChildren()));
