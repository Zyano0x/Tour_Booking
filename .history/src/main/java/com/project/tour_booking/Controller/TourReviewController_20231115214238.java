...
public class TourReviewController {
  ...
  @PutMapping("/update-tour-review")
  public ResponseEntity<TourReview> updateTourReview(TourReview tourReview, Long tourReviewId) {
    return new ResponseEntity<>(tourReviewService.updateTourReview(tourReview, tourReviewId), HttpStatus.OK);
  }

  @DeleteMapping("/admin/delete-tour-review/{tourReviewId}")
